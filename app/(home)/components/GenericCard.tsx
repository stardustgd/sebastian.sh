...
export default function GenericCard({
  ...
  return (
    <div className="relative flex w-full max-w-[32rem] flex-col rounded-xl bg-transparent bg-clip-border text-[#eceff4] shadow transition-all hover:scale-105 hover:border-t-4 hover:border-[#5e81ac]">
